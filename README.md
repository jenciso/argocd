...
# Clone Repository
Clone jenciso/argocd repository to your local device.
```
git clone https://github.com/jenciso/argocd.git
```
...
server:
  ...
  config:
    repositories: |
      - type: git
        url: https://github.com/jenciso/argocd.git
      - name: argo-helm
        type: helm
  ...
  additionalApplications: 
    - name: argocd
      ...
      source:
        ...
        repoURL: https://github.com/jenciso/argocd.git
        targetRevision: HEAD
      syncPolicy:
        syncOptions:
